...
| POST | `/api/v1/profesionales/{id}/horarios_disponibles/` | Obtener horarios por fecha |
...
Proyecto desarrollado como **Proyecto de Título** para la carrera de **Analista Programador** - 2025
